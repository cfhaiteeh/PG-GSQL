...
ENTITIES_FILENAME = 'myfiles/entities.txt'
ANONYMIZATION_FILENAME = 'myfiles/anonymization.txt'
...
class ATISDataset():
    ...
    def __init__(self, params):
        ...
        if 'atis' not in params.data_directory:
            print(params.data_directory)
            print(params.processed_train_filename)
            print(params.raw_train_filename)
            ...
            all_input_seqs =  valid_input_seqs+train_input_seqs
            ...
            sql_keywords = [ '=', 'select', ')', '(', 'where', 'by', ',', 'group', 'distinct',  'and', 'limit', 'desc', '>', 'avg', 'having', 'max', 'in', '<', 'sum',  'intersect', 'not', 'min', 'except', 'or', 'asc', 'like', '!', 'union', 'between', '-', '+', '/']
