...
UNK_TOK = "UNK"  # Replaces out-of-vocabulary words.
...
class Vocabulary:
    ...
    def __init__(self,
        ...
        vocab=['UNK', 'EOS', 'select', 'from', 'value', ')', '(', 'where', '=', 'by', ',', 'count', 'group', 'order', 'limit', 'desc', '>', 'distinct', 'and', 'avg', 'having', '<', 'in', 'sum', 'max', 'asc', 'not', 'or', 'like', 'min', 'intersect', 'except', '!', 'union', 'between', '-', '+']
        self.id_to_token = []
        self.token_to_id = {}
